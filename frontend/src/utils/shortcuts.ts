...
export const SHORTCUTS: Shortcut[] = [
  ...
  { id: 'mode1', label: '1', description: '阅读模式：单页', combo: '1', group: 'viewer' },
  { id: 'mode2', label: '2', description: '阅读模式：连续滚动', combo: '2', group: 'viewer' },
  { id: 'mode3', label: '3', description: '阅读模式：双页对开', combo: '3', group: 'viewer' },
  { id: 'fit', label: 'F', description: '图片适配循环（适应→按宽→按高→原始）', combo: 'f', group: 'viewer' },
  { id: 'direction', label: 'L', description: '阅读方向（左→右 / 右→左）', combo: 'l', group: 'viewer' },
