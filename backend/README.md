...
| 库     | `GET /api/library/manifest` · `GET /api/library/dashboard` · `GET /api/library/unread` · `GET /api/library/:id/children` · `GET /api/albums` · `GET /api/albums/:id/media` · `POST /api/library/nodes/query` · `GET /api/tags` |
