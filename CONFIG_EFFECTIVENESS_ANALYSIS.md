...
| 状态 | 数量 | 百分比 | 说明 |
|------|------|--------|------|
| ✅ **完全生效** | 5 | 22% | 已定义且在实际代码中应用 |
| ⚠️ **部分生效** | 4 | 17% | 仅在ConfigManager中定义或在设置对话框中保存 |
| ❌ **未生效** | 14 | 61% | 已定义但未在代码中实际使用 |
...
| 配置项 | 当前状态 |
|--------|----------|
| `last_path` | ✅ 有getter/setter，但MainWindow未使用 |
| `window_size` | ❌ 有getter/setter，但未使用(已用geometry替代) |
